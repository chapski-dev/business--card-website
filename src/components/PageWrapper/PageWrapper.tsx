  ...
  <div className="page-wrapper layout">
    ...
    <Footer >
      <div data-aos="fade-right" className="page-wrapper__footer-contacts">
        ...
        <a href="tel:+375291689232" target="_blank" className="page-wrapper__footer-contacts-phone" rel="noreferrer"><PhoneOutlined />Mobile: +375(29)168-92-53</a>
        <a href="https://github.com/chapski-dev" target="_blank" className="page-wrapper__footer-contacts-git" rel="noreferrer"><GithubOutlined />GitHub</a>
