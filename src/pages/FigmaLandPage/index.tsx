...
function FigmaLandPage() {
  ...
  return (
    <div className="figma-land-page">
      <header className="header">
        <div className="container">
          <nav className="nav">
            <a href="/#">
              <img
                src="./FigmaLandPage/img/Nav_logo.png"
                alt="Логотип"
                className="nav_logo"
              />
            </a>
            ...
            <button type="button" className="button nav_button">
              Sign up
            </button>
          </nav>
          <main className="main">
            <div className="main_title animate__animated animate__backInLeft">
              Find the Best Solution in Seconds
            </div>
            <div className="main_suptitle animate__animated animate__backInRight">
              If debugging is the process of removing software bugs.
            </div>
            <div className="main_buttons">
              <button
                type="button"
                className="button button_active main_button"
              >
                get started
              </button>
              <button type="button" className="button button_empty">
                try for free
              </button>
            </div>
            <img
              src="./FigmaLandPage/img/screen.png"
              alt=""
              className="main_img animate__animated animate__backInUp"
            />
          </main>
        </div>
      </header>
      <section className="section__info_links">
        <div className="container">
          <div className="section_title title">
            FigmaLand was Built Specifically for You
          </div>
          <div className="section_galary">
            <div className="section-box wow animate__animated animate__fadeInUp">
              <img
                src="./FigmaLandPage/img/sec_box_1.png"
                alt=""
                className="section_box_img"
              />
              <div className="section__box-title">Management</div>
              <div className="section__box-suptitle">
                Slate helps you see how many more days you need to work to reach
                your financial goal for the month and year.
              </div>
              <a href="/" className="section__box-link">
                Learn More
              </a>
            </div>
            <div
              className="section-box section-box_active wow animate__animated animate__fadeInUp"
              data-wow-delay=".5s"
            >
              <img
                src="./FigmaLandPage/img/sec_box_2.png"
                alt=""
                className="section_box_img"
              />
            ...
            <div
              className="section-box wow animate__animated animate__fadeInUp"
              data-wow-delay="1s"
            >
              <img
                src="./FigmaLandPage/img/sec_box_3.png"
                alt=""
                className="section-box__img"
              />
        ...
        <div className="container">
          <div className="procces-items">
            <div className="procces__info_mob">
              ...
              <div className="suptitle procces_suptitle">
            ...
            <div className="procces__info">
              ...
              <div className="procces__buttons">
                <button
                  type="button"
                  className="button button_blue procces_button-first"
                >
                  sign up for free
                </button>
                <button type="button" className="button button_empty-blue">
                  find out more
                </button>
              </div>
            </div>
            <img
              src="./FigmaLandPage/img/procces-img.png"
              alt=""
              className="procces-img wow animate__animated animate__fadeInRightBig"
            />
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="operations-items">
            <div className="operations__info_mob">
              <div className="title operation__title">
                Perfect for Operations HR and Finance
              </div>
              <div className="suptitle operation__suptitle">
            ...
            <img
              src="./FigmaLandPage/img/operations.png"
              alt=""
              className="operations-img wow animate__animated animate__fadeInLeftBig"
            />
            <div className="operations__info">
              ...
              <button
                type="button"
                className="button button_blue operation__button"
              >
                Button
              </button>
            </div>
        ...
        <div className="container">
          <div className="solutions-items">
            <div className="solution__text_mob">
              <div className="title solution_title">
                Perfect solution for small businesse
              </div>
              <div className="suptitle solution_suptitle">
                Being a freelancer is a
                <br />
                {' '}
            ...
            <div className="solution__text">
              ...
              <div className="buttons-solutins">
                <button
                  type="button"
                  className="button button_blue solution_button-left"
                >
                  sign up for free
                </button>
                <button
                  type="button"
                  className="button button_empty-blue solution"
                >
                  find out more
                </button>
              </div>
            ...
            <img
              src="./FigmaLandPage/img/solutin-img.png"
              alt=""
        ...
        <div className="container">
          <div className="pricing-items">
            <div className="pricing-items__text">
              ...
              <div className="suptitle pricing-items_suptitle">
            ...
            <div className="pricing-galary">
              <div className="pricing-box wow animate__animated animate__fadeInUp">
                ...
                <div className="suptitle pricing-box_suptitle">
                  Br/ief price Description
                </div>
                <img
                  src="./FigmaLandPage/img/pricing-1.png"
                  alt=""
                ...
                <div className="pricing-info">
                  ...
                  <p className="pricing__p pricing__p_mode">
                    Order Notifications
                  </p>
                  <p className="pricing__p pricing__p_mode">Landing Pages</p>
                  <button
                    type="button"
                    className="button button_blue button_pricing"
                  >
                    Order Now
                  </button>
                </div>
              ...
              <div
                className="pricing-box wow animate__animated animate__fadeInUp"
                data-wow-delay=".5s"
              >
                ...
                <img
                  src="./FigmaLandPage/img/pricing-2.png"
                  alt=""
                  className="pricing__box-img"
                />
                <div className="pricing-info">
              ...
              >
                ...
                <img
                  src="./FigmaLandPage/img/pricing-3.png"
                  alt=""
                  className="pricing__box-img"
                />
                <div className="pricing-info">
      ...
      <div className="subscribe">
        <div className="container">
          <div className="subscribe__items">
            ...
            <div className="suptitle subscribe_suptitle">
            ...
            <div className="subscribe__input">
              ...
              <button
                type="button"
                className="button button_blue subscribe_button"
              >
                SUBSCRIBE
              </button>
            </div>
      ...
      <footer className="footer wow animate__animated animate__fadeInUp">
        <div className="container">
          <div className="footer__items">
            ...
            <img
              src="./FigmaLandPage/img/footer-img.png"
              alt=""
            ...
            <div className="footer_contacts">
              <div className="footer__place">
                {' '}
                <img
                  src="./FigmaLandPage/img/footer-place.png"
                  alt=""
                  className="footer__img-place"
                />
                7480 Mockingbird Hill undefined
              </div>
              <div className="footer__phone">
                {' '}
                <img src="./FigmaLandPage/img/footer-phone.png" alt="" />
                <a href="tel:2395550108" className="tel_link">
                  (239) 555-0108
                </a>
              </div>
              <div className="footer__networks">
                <a href="/#" className="footer_networks-img">
                  <img
                    src="./FigmaLandPage/img/twitter.png"
                    alt=""
                ...
                <a href="/#" className="footer_networks-img">
                  <img
                    src="./FigmaLandPage/img/faceboock.png"
                    alt=""
                    className="network-twitter"
                  />
                </a>
                <a href="/#" className="footer_networks-img">
                  <img
                    src="./FigmaLandPage/img/inst.png"
                    alt=""
                    className="network-twitter"
                  />
                </a>
      ...
      <script src="./FigmaLandPage/js/wow.min.js" />
      {/* <script src="../../"></script> */}
