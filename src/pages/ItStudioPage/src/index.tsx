  ...
  return (
    <div className="it-studio-page">
      ...
      <section className="section-1">
        ...
        <button type="button" className="button">Наши проекты</button>
      </section>
        ...
        <div className="container">
          <div className="about_us">
            ...
            <div className="about_img">
              <img src="./essects/img/about_img.png" alt="" />
            </div>
          </div>
          ...
          <div className="statistics">
            <div className="stat_item">
              <div className="stat_img">
                <img src="./essects/img/window.png" alt="" />
              </div>
      ...
      <div className="offers">
        <div className="container">
          <div className="offer_header">
            ...
            <button type="button" className="button">Все услуги</button>
          </div>
          <div className="offer_section">
            <div className="offer_item">
              <img
                src="./essects/img/offers_img.png"
                alt=""
                className="offer_img"
              />
      ...
      <div className="progects">
        <div className="container">
          ...
          <div className="prog_items">
            <img
              src="./essects/img/progects_img.png"
              alt=""
              className="prog_img"
            />
            <img
          ...
          <button type="button" className="button">Все проекты</button>
        </div>
      </div>
        ...
        <div className="container">
          ...
          <div className="feedback">
            ...
            <div className="feedback_inputzone">
              ...
              />
              <button type="button" className="input_button">Подписаться</button>
            </div>
            <div className="feedback_ps">
        ...
        <div className="container">
          <div className="footer_info">
            <div className="footer_info_title">
              ...
              <div className="footer_list location">
